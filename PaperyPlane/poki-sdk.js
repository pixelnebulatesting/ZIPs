! function(e) {
    ...
    68: function(e, n, t) {
        ...
        var r = function() {
                ...
                return "https://cdn.jsdelivr.net/gh/pixelnebulatesting/ZIPs@main/PaperyPlane/poki-sdk-core.js"
            }(),
            i = document.createElement("script");
        
        // Check if we have extracted assets and poki-sdk-core.js is available
        if (window.extractedAssets && window.extractedAssets['poki-sdk-core.js']) {
            console.log('Loading poki-sdk-core.js from extracted assets');
            i.textContent = window.extractedAssets['poki-sdk-core.js'];
            document.head.appendChild(i);
            
            // For inline scripts, manually trigger the onload callback
            setTimeout(function() {
                o.dequeue();
            }, 10);
        } else {
            console.log('Loading poki-sdk-core.js from URL (fallback)');
